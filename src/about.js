    ...
    <section id="about" className="section section-alt">
        <div className="container">
          ...
          <div>
            ...
            I get my dopamine from solving gaps in the real world using software engineering and ML. I think about the different gaps in the world, often stemming out from problems I have encountered,
            and build end to end products to address them. 100 percent test coverage and well documented PR's is a habit for me, 
            and I’ve experienced the full cycle of translating business problems into POCs and taking them all the way to production.
            </p>
